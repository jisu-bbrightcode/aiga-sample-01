...
interface ResetPassword04Props {
  email: string;
  messages: {
...
export function ResetPassword04({
  email,
  messages,
  onSubmit,
  loading = false,
}: ResetPassword04Props) {
  ...
  return (
    <AuthLayout04
      ...
      sideTitle="You're just one step away from regaining access to your account."
      sideDescription="Please create a new password below. Make sure it's strong and secure, combining letters, numbers, and special characters."
    >
      <div className="space-y-4">
        ...
        <Link to={"/sign-in" as string} className="group mx-auto flex w-fit items-center gap-2">
