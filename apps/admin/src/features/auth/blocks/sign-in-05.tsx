...
export function SignIn05() {
  ...
  return (
    <AuthLayout05 title={t("signInTitle")} description={t("signInDescription")}>
      <div className="space-y-4">
        <div className="flex flex-row justify-center gap-3">
          <Button type="button" variant="outline" size="icon" onClick={signInWithGoogle}>
            <GoogleIcon />
        ...
        >
          ...
          <div className="flex items-center justify-between gap-y-2">
            ...
            <Link className="text-sm hover:underline" to={"/forgot-password" as string}>
