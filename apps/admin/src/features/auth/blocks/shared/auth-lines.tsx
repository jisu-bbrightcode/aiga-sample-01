...
const AuthLines = (props: SVGAttributes<SVGElement>) => {
  return (
    <svg
      ...
      {...props}
    >
      {/* 25 vertical lines with linear gradients */}
      <line
        x1="26.25"
        y1="1.07096e-08"
        x2="26.25"
      ...
      <defs>
        {Array.from({ length: 25 }, (_, i) => {
          const x = [
            25.5, 44.5, 64.5, 83.5, 103.5, 122.5, 142.5, 162.5, 181.5, 201.5, 220.5, 240.5, 259.5,
            278.5, 298.5, 317.5, 337.5, 356.5, 376.5, 396.5, 415.5, 435.5, 454.5, 474.5, 493.5,
          ][i];
          const y2 = [
            94.7007, 109.92, 130.213, 130.213, 145.433, 172.49, 172.49, 172.49, 145.433, 130.213,
            130.213, 109.92, 94.7007, 109.92, 130.213, 130.213, 145.433, 172.49, 172.49, 172.49,
            145.433, 130.213, 130.213, 109.92, 94.7007,
          ][i];
          return (
            <linearGradient
              key={i}
              id={`paint${i}_linear_20485_40176`}
              x1={x}
              y1="-2.14191e-08"
              x2={x}
              y2={y2}
