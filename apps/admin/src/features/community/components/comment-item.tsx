import type { CommunityComment } from "@repo/drizzle";
    ...
    >
      ...
      <div className="flex items-center gap-1.5 text-xs text-muted-foreground mb-2">
        ...
        {comment.distinguished && (
          <Badge
            variant="outline"
            className="text-green-600 border-green-200 dark:border-green-800 py-0 px-1.5 text-2xs"
          >
            MOD
          </Badge>
        )}
      ...
      {isCollapsed && (
        <p className="text-xs text-muted-foreground ml-7 mb-3">답글 {comment.replyCount}개 접힘</p>
      )}
    </div>
  );
}
