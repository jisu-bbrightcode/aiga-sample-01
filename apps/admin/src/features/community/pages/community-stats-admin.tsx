...
import { FileText, LayoutGrid, MessageSquare, RefreshCw, TrendingUp, Users } from "lucide-react";
import { useAdminCommunities, useCommunityStats } from "../hooks";
...
export function CommunityStatsAdmin() {
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-8">
      <PageHeader title="커뮤니티 통계" description="커뮤니티 전체 통계 및 인사이트" />
            ...
            {[
              {
                ...
                icon: <LayoutGrid className="size-3.5 text-muted-foreground" />,
              },
              {
                label: "전체 멤버",
