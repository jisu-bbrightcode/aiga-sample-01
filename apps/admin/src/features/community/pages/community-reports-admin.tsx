...
export function CommunityReportsAdmin() {
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-8">
      <PageHeader title="신고 관리" description="전체 커뮤니티의 신고된 콘텐츠" />
              ...
              return (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    {report.description && <p className="text-sm mb-1.5">{report.description}</p>}
...
function StatusBadge({ status }: StatusBadgeProps) {
  return (
    <Badge variant={statusBadgeVariants[status] ?? "outline"} className="text-xs">
