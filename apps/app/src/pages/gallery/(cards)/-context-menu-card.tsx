  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>@repo/ui/shadcn/context-menu</CardDescription>
      </CardHeader>
      <CardContent className="space-y-6">
        <section>
          ...
          <div className="border-border flex h-32 items-center justify-center rounded-md border border-dashed">
            <p className="text-muted-foreground text-sm">Right-click to see context menu</p>
          </div>
          <p className="text-muted-foreground mt-2 text-xs">
            Context menus are typically used in desktop applications. They appear when
