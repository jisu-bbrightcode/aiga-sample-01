  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>@repo/ui/shadcn/resizable</CardDescription>
      </CardHeader>
      <CardContent className="space-y-6">
        <section>
          ...
          <p className="text-muted-foreground mt-2 text-xs">
            A group of resizable panel components that can be used to build resizable layouts. Drag
            the handle between panels to resize.
          </p>
        </section>
      </CardContent>
    </Card>
