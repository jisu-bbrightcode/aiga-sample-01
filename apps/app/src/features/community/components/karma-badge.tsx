...
const KARMA_LEVELS = [
  {
    min: 5000,
    label: "Leader",
    className: "bg-yellow-500/10 text-yellow-700 dark:text-yellow-400 dark:bg-yellow-500/20",
  },
  {
    min: 2000,
    label: "Guide",
    className: "bg-purple-500/10 text-purple-700 dark:text-purple-400 dark:bg-purple-500/20",
  },
  {
    min: 500,
    label: "Helper",
  ...
  },
  {
    min: 100,
    label: "Contributor",
    className: "bg-green-500/10 text-green-700 dark:text-green-400 dark:bg-green-500/20",
  },
] as const;
...
export function KarmaBadge({ karma, className }: KarmaBadgeProps) {
  ...
  return (
    <Badge
      variant="outline"
      className={cn(
        "gap-0.5 border-transparent px-1.5 py-0 text-2xs",
        level.className,
        className,
      )}
    >
