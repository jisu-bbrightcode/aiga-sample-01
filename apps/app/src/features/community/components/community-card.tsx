import type { Community } from "@repo/drizzle/schema";
  ...
  return (
    ...
    >
      ...
      <div className="min-w-0 flex-1">
        <h3 className="truncate text-base font-medium">{community.name}</h3>
        <p className="text-muted-foreground line-clamp-1 text-base">{community.description}</p>
