...
import { AlertTriangle, ArrowRight, Clock, FileText, Settings, Shield, Users } from "lucide-react";
      ...
      <div className="flex items-center justify-between">
        <div className="space-y-1">
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-2xl font-semibold tracking-tight">모더레이터</h1>
          </div>
          <p className="text-base text-muted-foreground">c/{communitySlug}</p>
        </div>
      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
          <Link to="/c/$slug/mod/queue" params={{ slug: communitySlug }}>
            <div className="flex items-center gap-3 p-4 rounded-lg border hover:bg-muted transition-colors group">
              <FileText className="size-3.5 text-muted-foreground" />
              <div className="flex-1 min-w-0">
                <div className="text-base font-medium">검토 대기열</div>
          ...
          <Link to="/c/$slug/mod/reports" params={{ slug: communitySlug }}>
            <div className="flex items-center gap-3 p-4 rounded-lg border hover:bg-muted transition-colors group">
              ...
              <div className="flex-1 min-w-0">
                <div className="text-base font-medium">신고 관리</div>
          ...
          <Link to="/c/$slug/mod/logs" params={{ slug: communitySlug }}>
            <div className="flex items-center gap-3 p-4 rounded-lg border hover:bg-muted transition-colors group">
              ...
              <div className="flex-1 min-w-0">
                <div className="text-base font-medium">활동 기록</div>
          ...
          <div className="flex items-center gap-3 p-4 rounded-lg border hover:bg-muted transition-colors group cursor-pointer">
            <Users className="size-3.5 text-muted-foreground" />
            <div className="flex-1 min-w-0">
              <div className="text-base font-medium">사용자 관리</div>
          ...
          <div className="flex items-center gap-3 p-4 rounded-lg border hover:bg-muted transition-colors group cursor-pointer">
            ...
            <div className="flex-1 min-w-0">
              <div className="text-base font-medium">커뮤니티 설정</div>
      ...
      <div>
        ...
        <div className="space-y-1">
          {[
            {
              label: "게시글 삭제됨",
              detail: "스팸 게시글이 삭제되었습니다",
              time: "5분 전",
              color: "text-red-500",
            },
            {
              label: "사용자 차단",
              detail: "u/spammer123이 차단되었습니다",
              time: "1시간 전",
              color: "text-yellow-500",
            },
            {
              label: "신고 해결됨",
              detail: "3건의 신고가 해결되었습니다",
              time: "3시간 전",
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                ...
                <span className="text-base text-muted-foreground ml-2">{item.detail}</span>
              </div>
