...
import { AlertCircle, ArrowLeft, Globe, Lock, ShieldCheck } from "lucide-react";
...
export function CreateCommunityForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (formData.name.length < 3) {
      newErrors.name = t("errors.communityNameMin");
    }
    if (formData.slug.length < 3) {
      newErrors.slug = t("errors.communitySlugMin");
    }
    if (!/^[a-z0-9-]+$/.test(formData.slug)) {
      newErrors.slug = t("errors.communitySlugPattern");
    }
    if (formData.description.length < 10) {
      newErrors.description = t("errors.communityDescriptionMin");
    }
    ...
    try {
      ...
      setServerError(getAppErrorMessage(t, error, "errors.communityCreate"));
    }
  };
  ...
  return (
    <div className="max-w-xl mx-auto">
      ...
      <div className="space-y-1 mb-8">
        <h1 className="text-2xl font-semibold tracking-tight">커뮤니티 만들기</h1>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        {serverError && (
          <div className="flex items-center gap-2 p-3 text-base text-destructive bg-destructive/5 border border-destructive/20 rounded-lg">
        ...
        <div className="space-y-2">
          ...
          <div className="flex items-center gap-2">
            <span className="text-base text-muted-foreground shrink-0">c/</span>
            <Input
              id="slug"
              value={formData.slug}
              onChange={(e) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="min-w-0">
                    <div className={cn("text-base font-medium", isSelected && "text-primary")}>
                      {option.label}
                    </div>
        ...
        <div className="flex items-center justify-between p-3 rounded-lg border">
          <div>
            <div className="text-base font-medium">18+ NSFW 커뮤니티</div>
