...
import { FileText, Inbox, MessageSquare, User } from "lucide-react";
...
export function CommunityReportsAdmin() {
  const [statusFilter, setStatusFilter] = useState<"all" | "pending" | "reviewing" | "resolved">(
    "pending",
  );
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-8">
      ...
      <div className="space-y-1">
        ...
        <p className="text-base text-muted-foreground">전체 커뮤니티의 신고된 콘텐츠</p>
      </div>
      ...
      <div className="space-y-2">
        {reports.length === 0 ? (
          <div className="flex flex-col items-center py-16 text-center">
            ...
            <p className="text-base text-muted-foreground">신고가 없습니다</p>
          </div>
        ) : (
          reports.map((report) => {
            ...
            return (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-base mb-1.5">{report.description}</p>

                  <div className="text-xs text-muted-foreground">
                    신고자: u/{report.reporterName} · 대상:{" "}
