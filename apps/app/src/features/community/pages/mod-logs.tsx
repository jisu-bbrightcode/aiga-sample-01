...
import { FileText, Lock, Pin, Shield, Trash2, UserX } from "lucide-react";
    ...
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="space-y-1">
          <h1 className="text-2xl font-semibold tracking-tight">활동 기록</h1>
      ...
      <div className="space-y-1">
        {logs.map((log) => {
          ...
          return (
            <div
              key={log.id}
              className="flex items-start gap-3 px-3 py-3 rounded-lg hover:bg-muted transition-colors"
            >
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="mt-1 text-base">
                  ...
                  {log.targetUsername && (
                    <span className="font-medium">u/{log.targetUsername}</span>
                  )}
                  {log.reason && (
