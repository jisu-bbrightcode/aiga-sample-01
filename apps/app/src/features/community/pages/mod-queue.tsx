...
import { Check, FileText, Inbox, MessageSquare, X } from "lucide-react";
    ...
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="space-y-1">
          <h1 className="text-2xl font-semibold tracking-tight">검토 대기열</h1>
      ...
      <div className="space-y-2">
        {queueItems.length === 0 ? (
          <div className="flex flex-col items-center py-16 text-center">
            ...
            <p className="text-base text-muted-foreground">검토 대기 중인 콘텐츠가 없습니다</p>
          </div>
        ) : (
          queueItems.map((item) => (
            <div
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                ...
                {item.type === "comment" && item.postTitle && (
                  <div className="text-xs text-muted-foreground mb-1">게시글: {item.postTitle}</div>
                )}

                <p className="text-base text-muted-foreground line-clamp-2">{item.content}</p>
              </div>
