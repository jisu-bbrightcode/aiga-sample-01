  ...
  return (
    <div className="max-w-5xl mx-auto space-y-8">
      ...
      <div className="space-y-1">
        ...
        <p className="text-base text-muted-foreground">커뮤니티 전체 통계 및 인사이트</p>
      </div>
            ...
            {topCommunities.map((community, index) => (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <div className="text-base font-medium">c/{community.slug}</div>
                  <div className="text-xs text-muted-foreground">
                    {community.members.toLocaleString()} 멤버 · {community.posts.toLocaleString()}{" "}
                    게시글
                  </div>
                </div>
          ...
          <div className="space-y-1">
            {topUsers.map((user, index) => (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <div className="text-base font-medium">u/{user.username}</div>
                  <div className="text-xs text-muted-foreground">
