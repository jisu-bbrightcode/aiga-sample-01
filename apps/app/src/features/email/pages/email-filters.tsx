...
import type { EmailStatus, EmailTemplateType } from "../../common/types";
import { EMAIL_STATUS_LABELS, EMAIL_TEMPLATE_LABELS } from "../../common/types";
    ...
    <div className="flex flex-col gap-4 md:flex-row md:items-end">
      ...
      <div className="w-full md:w-[200px]">
        ...
        <Select
          ...
          onValueChange={(v: string | null) =>
            onStatusChange(v === "all" || !v ? undefined : (v as EmailStatus))
          }
        >
      ...
      <div className="w-full md:w-[200px]">
        ...
        <Select
          ...
          onValueChange={(v: string | null) =>
            onTemplateTypeChange(v === "all" || !v ? undefined : (v as EmailTemplateType))
          }
        >
