...
import { EmailLogResponseDto, PreviewTemplateResponseDto, ResendEmailResponseDto } from "../dto";
...
export class EmailController {
  ...
  @ApiResponse({ status: 200, description: "이메일 로그 목록 반환", type: EmailLogResponseDto, isArray: true })
