...
@ApiTags("Reaction")
@ApiExtraModels(ReactionCountsDto, ToggleReactionResponseDto, UserReactionStatusDto)
@Controller("reaction")
export class ReactionController {
  ...
  @ApiResponse({ status: 200, description: "Returns reaction counts by type", type: ReactionCountsDto })
  async getCounts(
  ...
  @ApiBody({
    schema: {
      ...
      properties: {
        ...
        targetIds: { type: "array", items: { type: "string", format: "uuid" }, description: "Target entity IDs" },
      },
  ...
  @ApiResponse({ status: 200, description: "Toggle result (added: true/false)", type: ToggleReactionResponseDto })
  ...
  @ApiQuery({ name: "targetId", required: true, description: "Target entity ID (UUID)" })
  @ApiResponse({ status: 200, description: "Returns user reaction status", type: UserReactionStatusDto })
  @ApiResponse({ status: 401, description: "Authentication required" })
  async getUserStatus(
    @CurrentUser() user: User,
    @Query("targetType") targetType: string,
