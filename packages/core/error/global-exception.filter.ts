...
import { getHttpStatus, isAppError } from "@repo/shared/errors";
...
export class GlobalExceptionFilter implements ExceptionFilter {
  ...
  // biome-ignore lint/complexity/noExcessiveCognitiveComplexity: exception catch has many narrow branches
