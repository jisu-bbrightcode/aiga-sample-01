...
```typescript
import { baseColumns, softDelete } from "@repo/drizzle/utils";
...
```typescript
import { id, timestamps } from "@repo/drizzle/utils";
...
```typescript
import type { InsertModel, SelectModel, UpdateModel } from "@repo/drizzle/utils";
