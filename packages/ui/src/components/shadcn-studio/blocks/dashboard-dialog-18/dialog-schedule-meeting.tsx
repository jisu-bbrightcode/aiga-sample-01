                ...
                <DropdownMenu>
                  <DropdownMenuTrigger
                    render={
                      <Button
                        size="lg"
                        className="bg-primary/10 text-primary hover:bg-primary/20 capitalize md:w-max"
                      />
                    }
                  >
                    {repeat}
                  ...
                  <DropdownMenuContent>
                    <DropdownMenuGroup>
                      <DropdownMenuItem onClick={() => setRepeat("weekly")}>
                        Weekly
                      </DropdownMenuItem>
                      <DropdownMenuItem onClick={() => setRepeat("biweekly")}>
                        Biweekly
                      </DropdownMenuItem>
                    </DropdownMenuGroup>
                  </DropdownMenuContent>
                      ...
                      return (
                        ...
                        >
                          <div className="flex items-center gap-2">
                            ...
                            <Badge className="bg-primary/10 focus-visible:ring-primary/20 text-primary border-none focus-visible:outline-none">
                              {formatBytes(
