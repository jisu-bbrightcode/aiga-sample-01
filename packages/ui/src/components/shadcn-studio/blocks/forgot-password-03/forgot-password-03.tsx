...
import LogoVector from "src/assets/svg/logo-vector";
import ForgotPasswordForm from "src/components/shadcn-studio/blocks/forgot-password-03/forgot-password-form";
        ...
        <Card className="bg-primary relative h-full justify-between border-none py-8">
          <CardHeader className="gap-6 px-8">
            ...
            <p className="text-primary-foreground text-xl">
              Just enter your registered email address below, and we&apos;ll send you a secure link
              to reset your password. Follow the instructions in the email, and you&apos;ll be back
          ...
          <CardContent className="relative z-1 mx-8 h-62 overflow-hidden rounded-2xl px-0">
            ...
            <div className="flex flex-col gap-5 p-6">
              ...
              <p className="line-clamp-2 text-lg">
                If you don&apos;t see the email in your inbox, be sure to check your spam or junk
                folder.
              </p>
