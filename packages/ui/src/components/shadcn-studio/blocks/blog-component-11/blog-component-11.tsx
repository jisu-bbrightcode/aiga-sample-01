...
import { MotionPreset } from "@repo/ui/shadcn/motion-preset";
        ...
        <div className="mb-12 space-y-4 text-center sm:mb-16 lg:mb-24">
          ...
          >
            <p className="text-muted-foreground mx-auto max-w-2xl text-base lg:text-xl">
              Dive into stories, strategies, and lessons from our team as we design, build, and
              scale modern digital products.
            </p>
          </MotionPreset>
