...
const changeTypeIcons: Record<ChangeType, ReactNode> = {
  major: <ArrowRightIcon className="size-3.5" />,
  minor: <ArrowRightIcon className="size-3.5" />,
  patch: <ArrowRightIcon className="size-3.5" />,
  added: <PlusIcon className="size-3.5" />,
  removed: <MinusIcon className="size-3.5" />,
};
    ...
    >
      {children ?? (
        <>
          ...
          {currentVersion && newVersion && <ArrowRightIcon className="size-3.5" />}
