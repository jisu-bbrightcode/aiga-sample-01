...
export const SchemaDisplayParameters = ({
  ...
  return (
    <Collapsible className={cn(className)} defaultOpen {...props}>
      <CollapsibleTrigger className="group flex w-full items-center gap-2 px-4 py-3 text-left transition-colors hover:bg-muted">
  ...
  if (hasChildren) {
    return (
      <Collapsible defaultOpen={depth < 2}>
        <CollapsibleTrigger
          className={cn(
            "group flex w-full items-center gap-2 py-3 text-left transition-colors hover:bg-muted",
            className,
          )}
          style={{ paddingLeft }}
        >
    ...
    <div className="w-full max-w-2xl p-4">
      <div className="overflow-hidden rounded-lg border bg-background">
        ...
        <Collapsible defaultOpen>
          <CollapsibleTrigger className="group flex w-full items-center gap-2 px-4 py-3 text-left hover:bg-muted">
