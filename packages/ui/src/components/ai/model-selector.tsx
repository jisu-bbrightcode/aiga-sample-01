...
const getProviderInitial = (provider: string) => provider.slice(0, 1).toUpperCase();
...
export const ModelSelectorLogo = ({ provider, className, ...props }: ModelSelectorLogoProps) => (
  <span
    ...
    className={cn(
      "inline-flex size-3 shrink-0 items-center justify-center rounded-full bg-muted font-medium text-muted-foreground text-xs leading-none ring-1 ring-border [&>span]:scale-75",
      className,
    )}
  >
