    ...
    <PromptInputHoverCard>
      <HoverCardTrigger
        render={
          <div
            className={cn(
              "group relative flex h-8 cursor-pointer select-none items-center gap-1.5 rounded-md border border-border px-1.5 font-medium text-sm transition-all hover:bg-muted hover:text-foreground dark:hover:bg-muted",
              className,
            )}
            key={data.id}
            {...props}
...
export const PromptInputTabItem = ({ className, ...props }: PromptInputTabItemProps) => (
  <div
    className={cn("flex items-center gap-2 px-3 py-2 text-xs hover:bg-muted hover:text-foreground", className)}
    {...props}
  />
);
...
export default function PromptInputDemo() {
  return (
    <div className="size-full">
      <PromptInput multiple onSubmit={(_message) => {}}>
