  ...
  return (
    ...
    >
      <div className="bg-background flex size-8 items-center justify-center rounded-full shadow-md transition-all duration-200 ease-out">
        {refreshing ? (
          <DynamicIcon name="loader-circle" className="text-primary size-3.5" />
        ) : (
          <DynamicIcon
            name="arrow-down"
            className="text-muted-foreground data-[reached=true]:text-primary size-3.5 transition-transform duration-200"
            style={{
              opacity: progress,
