import { Check, ChevronDown, ChevronRight, Eye, MoreHorizontal } from "lucide-react";
...
export const NotionCalendarEventGroup = React.forwardRef<
  HTMLDivElement,
  NotionCalendarEventGroupProps
>(
  (
    {
      className,
              ...
              calendars.map((cal) => (
                ...
                >
                  <div className="flex items-center gap-2 truncate">
                    ...
                    {cal.isDefault && (
                      <span className="text-2xs text-muted-foreground px-1 bg-muted rounded">
                        기본
                      </span>
                    )}
                  </div>
