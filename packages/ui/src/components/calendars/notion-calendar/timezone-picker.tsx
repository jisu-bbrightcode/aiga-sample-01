    ...
    >
      ...
      <div className="px-3 py-2.5 border-b border-white/10">
        <input
          ...
          placeholder="시간대"
          className="w-full bg-transparent text-white/90 text-xs placeholder:text-white/40 outline-none"
        />
      </div>
        ...
        {filtered.length === 0 ? (
          ...
          filtered.map((tz) => (
            <button
              ...
              className="w-full text-left px-3 py-2 text-xs text-white/80 hover:bg-white/10 transition-colors flex items-baseline gap-1.5 cursor-pointer"
            >
              <span className="text-white/50 shrink-0 font-mono text-2xs">{tz.label}</span>
