...
function AvatarImage({ className, crossOrigin, render, ...props }: AvatarPrimitive.Image.Props) {
  return (
    <AvatarPrimitive.Image
      data-slot="avatar-image"
      className={cn("rounded-full aspect-square size-full object-cover", className)}
      crossOrigin={crossOrigin}
      render={render ?? (crossOrigin ? <img alt="" crossOrigin={crossOrigin} /> : undefined)}
      {...props}
    />
  );
}
